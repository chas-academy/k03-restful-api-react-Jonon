...
export const Search = Radium(({ width, height, stroke, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="ionicon"
...
export const Add = Radium(({ width, height, fill, customStyle, stroke }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fill}
...
export const Remove = Radium(({ width, height, fill, customStyle, stroke }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fill}
...
export const Cog = Radium(({ width, height, fill, customStyle, stroke }) => {
  return (
    <svg
      ...
      height={height}
      viewBox="0 0 24 24"
      style={[styles.stroke[fill], fill, customStyle]}
    >
