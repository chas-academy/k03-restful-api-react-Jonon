...
export const Cart = ({ width, height, fill }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const UserOutline = ({ width, height, fill }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const Logo = ({ width, height, fill }) => {
  return (
    <svg
...
export const ChevronRight = ({ width, height, fill }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const Instagram = ({ width, height, fill }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const YouTube = ({ width, height, fill }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Menu = ({ width, height, fill }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Star = ({ width, height, fill }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
