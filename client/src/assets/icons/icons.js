...
export const Cart = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const Search = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="ionicon"
...
export const User = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const UserOutline = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const Logo = ({ width, height, fill, customStyle }) => {
  return (
    <svg
...
export const ChevronRight = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
...
export const Facebook = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Twitter = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Instagram = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const YouTube = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Star = ({ width, height, fill, customStyle }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
